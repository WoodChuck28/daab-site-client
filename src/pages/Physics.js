      ...
      <div></div>
        ...
        padding: "5px"}}>
          ...
          <ul style={{textAlign: "center", background: "#354e01"}}>
            <li style={{background: "#354e01"}}><strong style={{fontSize: "18px"}}>1. CB: Link to Collegeboard's unit outline guide. Includes standards, science practices, and I can statements</strong></li>
        ...
        <ResponsiveGrid style={{background:"#354e01"}} className="testertester"></ResponsiveGrid>
      </div>
    );
  }
